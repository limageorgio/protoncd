...
# -*- coding: utf-8 -*-
"""
Atualiza artigo_relacionado de elev-103..112 em:
...
CREATED_FILE = BASE_DIR / "batch_103_112_created_files.json"
...
def update_elevadores_index_cards(text: str, item_map: dict):
    ...
    card_specs = {
        "elev-103": ("fas fa-sliders-h", "orange", "Sem codificação de comandos, cresce o risco de erro humano."),
        "elev-104": ("fas fa-fire-extinguisher", "red", "Sem painel no pavimento de descarga, falha operação de emergência."),
        "elev-105": ("fas fa-door-closed", "red", "Sem compartimentação corta-fogo, o resgate fica comprometido."),
        "elev-106": ("fas fa-tachometer-alt", "orange", "Velocidade insuficiente reduz resposta em prédio alto."),
        "elev-107": ("fas fa-weight-hanging", "orange", "Capacidade divergente favorece sobrecarga e uso indevido."),
        "elev-108": ("fas fa-clipboard-check", "blue", "Sem checklist pós-serviço, faltam rastreabilidade e controle."),
        "elev-109": ("fas fa-ruler-combined", "red", "Folga crítica entre cabina e contrapeso requer ação imediata."),
        "elev-110": ("fas fa-exclamation-circle", "orange", "Sem instrução, abertura de emergência pode causar acidente."),
        "elev-111": ("fas fa-th-large", "blue", "Painéis internos soltos podem desprender e gerar lesão."),
        "elev-112": ("fas fa-wave-square", "orange", "Vibração no contrapeso acelera desgaste e compromete a corrida."),
    }
