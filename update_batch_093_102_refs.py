...
# -*- coding: utf-8 -*-
"""
Atualiza artigo_relacionado de elev-093..102 em:
...
CREATED_FILE = BASE_DIR / "batch_093_102_created_files.json"
...
def update_elevadores_index_cards(text: str, item_map: dict):
    ...
    card_specs = {
        "elev-093": ("fas fa-door-closed", "orange", "Fechamento lento amplia exposição da abertura e exige ajuste técnico."),
        "elev-094": ("fas fa-file-signature", "orange", "Sem inspeção documentada, aumenta risco técnico e jurídico."),
        "elev-095": ("fas fa-link", "orange", "Tensão desigual nos cabos acelera desgaste e afeta nivelamento."),
        "elev-096": ("fas fa-shield-alt", "orange", "Proteção IP inadequada reduz confiabilidade de componentes."),
        "elev-097": ("fas fa-exclamation-triangle", "orange", "Travamento entre andares recorrente requer ação prioritária."),
        "elev-098": ("fas fa-lightbulb", "blue", "Indicador de pavimento inoperante prejudica orientação e acessibilidade."),
        "elev-099": ("fas fa-lock", "red", "Quadro sem barreira física expõe leigos a risco elétrico crítico."),
        "elev-100": ("fas fa-ruler-combined", "orange", "Folga anormal nas portas eleva risco de aprisionamento."),
        "elev-101": ("fas fa-cogs", "blue", "Ruído de rolamento indica desgaste e possível travamento da porta."),
        "elev-102": ("fas fa-stop-circle", "red", "Sem teste funcional, falhas do freio podem passar despercebidas."),
    }
