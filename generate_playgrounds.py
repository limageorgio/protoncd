...
<body>
    ...
    <div class="nav-mobile-menu" id="mobile-menu">
        <button class="nav-mobile-close" id="mobile-close" aria-label="Fechar menu">&times;</button>
        <a href="../../index.html#inicio" class="mobile-link">Inicio</a>
        <a href="../../index.html#servicos" class="mobile-link">Servicos</a>
    ...
    <main class="article-container">
        <article class="article-content">
            ...
            <p>Na pratica de inspecao, esse desvio tende a surgir por combinacao de desgaste operacional, variacao geometrica e manutencao reativa. Em ambientes com alta frequencia de uso infantil, a janela entre desvio leve e evento costuma ser curta.</p>
            <ul>
                <li><strong>Origem:</strong> perda de conformidade dimensional, fixacao inadequada ou degradacao de componentes.</li>
                <li><strong>Exposicao:</strong> repeticao de ciclos de uso sem bloqueio preventivo do ponto critico.</li>
                <li><strong>Efeito provavel:</strong> queda, aprisionamento, impacto secundario ou lesoes por contato.</li>
                <li><strong>Agravantes:</strong> umidade, vandalismo, ausencia de rotina documentada de inspecao e manutencao.</li>
            </ul>
            ...
            <ul>
                <li>Registro fotografico com escala de medida e identificacao inequivoca do ponto.</li>
                <li>Medicoes funcionais e dimensionais comparadas ao criterio normativo aplicavel.</li>
                <li>Teste operacional controlado para confirmar o modo de falha em condicao segura.</li>
                <li>Verificacao do entorno: piso, ancoragens, rota de acesso e elementos adjacentes.</li>
                <li>Classificacao de risco com prazo, responsavel e condicao de liberacao apos correcao.</li>
            </ul>
            ...
            <table class="decision-table">
                ...
                <tbody>
                    <tr><td>Risco critico com exposicao infantil direta</td><td>Interdicao imediata do ponto ou equipamento e barreira fisica</td><td>0-24h</td></tr>
                    <tr><td>Risco alto com tendencia de agravamento</td><td>Correcao prioritaria e reinspecao tecnica formal</td><td>Ate 7 dias</td></tr>
                    <tr><td>Risco moderado sob controle provisorio</td><td>Plano corretivo com marcos de execucao e monitoramento</td><td>Ate 30 dias</td></tr>
                </tbody>
            </table>

            <h2>5. Plano de melhoria recomendado</h2>
            <ul>
                <li><strong>Contencao:</strong> restringir acesso ao risco ate eliminacao da causa tecnica.</li>
                <li><strong>Correcao:</strong> adequar componente, geometria e metodo de fixacao conforme norma.</li>
                <li><strong>Validacao:</strong> reinspecionar e liberar somente com evidencia objetiva de conformidade.</li>
                <li><strong>Prevencao:</strong> incorporar o item na rotina periodica com checklist rastreavel.</li>
            </ul>
                ...
                <p style="margin-bottom: var(--space-4);">A Proton Engenharia realiza diagnostico tecnico com criterios da ABNT NBR 16071 e plano de acao priorizado para reduzir risco e passivo.</p>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    <a href="../../index.html" class="nav-logo" style="margin-bottom: var(--space-4); display: inline-flex;">
                        <img src="../../img/logo_proton_branco.png" alt="Proton Engenharia" width="36" height="36">
                        <span class="nav-logo-text">PROTON <span>Engenharia</span></span>
                    </a>
                    <p>Engenharia diagnostica com tecnologia 360 exclusiva. Inspecao de playgrounds, laudos tecnicos e pericias mecanicas com ART-CREA.</p>
                </div>
                <div class="footer-col">
                    <h4>Servicos</h4>
                    <ul>
                        <li><a href="../../inspecao-playgrounds.html">Inspecao de Playgrounds</a></li>
                        <li><a href="../../inspecao-predial.html">Inspecao Predial 360</a></li>
                        <li><a href="../../laudo-pericial-engenharia.html">Laudos Periciais</a></li>
                        <li><a href="../../landing-servicos.html">Todos os Servicos</a></li>
                    </ul>
                </div>
                <div class="footer-col">
                    <h4>Artigos Relacionados</h4>
                    <ul>
                        <li><a href="../index.html">Ver Todos</a></li>
                        <li><a href="artigo-playground-ferrugem-desgaste.html">Ferrugem e Desgaste</a></li>
                        <li><a href="../elevadores/artigo-elevadores-poco-contaminado.html">Elevadores</a></li>
                    </ul>
                </div>
                <div class="footer-col">
                    <h4>Contato</h4>
                    <ul>
                        <li><a href="tel:5562992852704"><i class="fas fa-phone" style="margin-right: 6px;"></i> (62) 99285-2704</a></li>
                        <li><a href="mailto:lima.georgio.eng@gmail.com"><i class="fas fa-envelope" style="margin-right: 6px;"></i> E-mail</a></li>
                        <li><a href="https://api.whatsapp.com/send?phone=5562992852704" target="_blank" rel="noopener noreferrer"><i class="fab fa-whatsapp" style="margin-right: 6px;"></i> WhatsApp</a></li>
                    </ul>
                </div>
            </div>
            <div class="footer-bottom">
                ...
                <div class="footer-social">
                    <a href="https://www.linkedin.com/in/georgiolima/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><i class="fab fa-linkedin-in"></i></a>
