...
batch = {
    "elev-033": {
        "slug": "artigo-elevadores-chicotes-cabos-controle-protecao-inspecao",
        "rel_title": "Proteção dos Chicotes e Cabos de Controle no Poço",
        "card_title": "Chicotes e Cabos de Controle",
        "card_text": "Proteção, inspeção e risco elétrico no trajeto dos chicotes do poço.",
        "icon": "fas fa-plug",
        "icon_color": "orange",
        "hero": "hero-cabos.svg"
    },
    "elev-034": {
        "slug": "artigo-elevadores-placa-capacidade-cabina",
        "rel_title": "Placa de Capacidade da Cabina: Exigência e Conformidade",
        "card_title": "Placa de Capacidade",
        "card_text": "Legibilidade e limite nominal para operação segura da cabina.",
        "icon": "fas fa-id-badge",
        "icon_color": "blue",
        "hero": "hero-poco.svg"
    },
    "elev-035": {
        "slug": "artigo-elevadores-ventilacao-cabina",
        "rel_title": "Ventilação da Cabina: Segurança e Conforto Operacional",
        "card_title": "Ventilação da Cabina",
        "card_text": "Respiros funcionais para conforto térmico e segurança em aprisionamento.",
        "icon": "fas fa-wind",
        "icon_color": "blue",
        "hero": "hero-poco.svg"
    },
    "elev-036": {
        "slug": "artigo-elevadores-chave-triangular-destravamento-emergencia",
        "rel_title": "Chave Triangular de Destravamento: Uso Seguro em Emergência",
        "card_title": "Chave Triangular (Uso Seguro)",
        "card_text": "Procedimento correto para destravamento sem comprometer a segurança.",
        "icon": "fas fa-key",
        "icon_color": "red",
        "hero": "hero-poco.svg"
    },
    "elev-037": {
        "slug": "artigo-elevadores-vidros-espelhos-cabina-padrao",
        "rel_title": "Vidros e Espelhos da Cabina: Padrão Técnico Obrigatório",
        "card_title": "Vidros e Espelhos",
        "card_text": "Exigência de vidro seguro e marcação permanente em cabina.",
        "icon": "fas fa-clone",
        "icon_color": "gray",
        "hero": "hero-poco.svg"
    },
    "elev-038": {
        "slug": "artigo-elevadores-interfone-emergencia-cabina",
        "rel_title": "Interfone de Emergência na Cabina: Item Crítico",
        "card_title": "Interfone de Emergência",
        "card_text": "Comunicação bidirecional obrigatória para resgate e suporte aos ocupantes.",
        "icon": "fas fa-phone-volume",
        "icon_color": "red",
        "hero": "hero-poco.svg"
    },
    "elev-039": {
        "slug": "artigo-elevadores-saia-protecao-avental-cabina",
        "rel_title": "Saia de Proteção (Avental) da Cabina: Função e Risco",
        "card_title": "Saia de Proteção (Avental)",
        "card_text": "Componente crítico contra acesso perigoso ao vão do poço.",
        "icon": "fas fa-shield-alt",
        "icon_color": "red",
        "hero": "hero-poco.svg"
    },
    "elev-040": {
        "slug": "artigo-elevadores-protecao-antissalto-cabos-polias",
        "rel_title": "Proteção Antissalto em Cabos e Polias: Controle de Risco",
        "card_title": "Proteção Antissalto",
        "card_text": "Presença e integridade da proteção para manter geometria segura.",
        "icon": "fas fa-link",
        "icon_color": "orange",
        "hero": "hero-cabos.svg"
    },
    "elev-041": {
        "slug": "artigo-elevadores-fim-de-curso-limitador-final",
        "rel_title": "Fim de Curso (Limitador Final): Última Barreira de Segurança",
        "card_title": "Fim de Curso",
        "card_text": "Dispositivo final que evita ultrapassagem dos limites da corrida.",
        "icon": "fas fa-ban",
        "icon_color": "red",
        "hero": "hero-poco.svg"
    },
    "elev-042": {
        "slug": "artigo-elevadores-chave-triangular-sem-aviso-seguranca",
        "rel_title": "Chave Triangular sem Aviso: Risco Operacional e Responsabilidade",
        "card_title": "Chave sem Aviso de Segurança",
        "card_text": "Ausência de advertência aumenta risco de uso indevido e acidente.",
...
sev_cfg = {
    "Crítica": {"score": "9.5/10", "window": "Imediata (0-24h)", "tag": "CRÍTICA", "risk": (94, 96, 92, 98), "priority": "Correção imediata"},
    "Alta": {"score": "8.4/10", "window": "Curta (até 72h)", "tag": "ALTA", "risk": (82, 86, 80, 90), "priority": "Ação urgente"},
    "Média": {"score": "6.4/10", "window": "Programada (até 30 dias)", "tag": "MÉDIA", "risk": (62, 58, 60, 66), "priority": "Plano corretivo"}
}
...
# Update conhecimento-tecnico/index.html blocks for 033..042
...
for fid, cfg in batch.items():
    ...
    if '"artigo_relacionado"' in block:
        block_new = re.sub(r'"artigo_relacionado":\s*\{[\s\S]*?\},\n', rel_block, block, count=1)
    else:
        block_new = re.sub(r'("normas":\s*\[[\s\S]*?\]\s*,\n)', r'\1                                             ' + rel_block, block, count=1)
...
new_cards = []
for fid in ["elev-033", "elev-034", "elev-035", "elev-036", "elev-037", "elev-038", "elev-039", "elev-040", "elev-041", "elev-042"]:
    cfg = batch[fid]
...
print("Batch elev-033..042 aplicado com sucesso.")
