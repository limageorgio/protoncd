...
# -*- coding: utf-8 -*-
"""
Validação final do lote elev-113 a elev-122.
"""
...
BATCH_FILE = BASE_DIR / "batch_113_122_created_files.json"
...
def main():
    ...
    if len(items) != 10:
        errors.append(f"batch_113_122_created_files.json deveria ter 10 itens e tem {len(items)}")
